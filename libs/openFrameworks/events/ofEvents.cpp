...
//------------------------------------------
void ofNotifyScrollEvent(const ofScrollEventArgs & scrollEvent){
    switch(scrollEvent.type){
        case ofScrollEventArgs::Up:
            ofNotifyScrollUp( scrollEvent.x, scrollEvent.y );
            break;
        case ofScrollEventArgs::Down:
            ofNotifyScrollDown( scrollEvent.x, scrollEvent.y );
            break;
    }
}
...
//------------------------------------------
void ofNotifyScrollUp(double x, double y){
    static ofScrollEventArgs scrollEventArgs;
    
    scrollEventArgs.x = x;
    scrollEventArgs.y = y;
    scrollEventArgs.type = ofScrollEventArgs::Up;
    
    ofNotifyEvent( ofEvents().scrolling, scrollEventArgs );
}

//------------------------------------------
void ofNotifyScrollDown(double x, double y){
    static ofScrollEventArgs scrollEventArgs;
    
    scrollEventArgs.x = x;
    scrollEventArgs.y = y;
    scrollEventArgs.type = ofScrollEventArgs::Down;
